...
| 检查项 | 分值 | 判定标准 | 脚本/证据 |
| :--- | :---: | :--- | :--- |
| **业务流程图** | **25分** | 含 mermaid/图片/流程描述 | `structure.has_flowcharts` |
| **目标用户** | **15分** | 明确定义适用人群/画像 | 原文引用 |
| **数据埋点** | **15分** | 定义统计指标/埋点事件 | 原文引用 |
| **异常流程** | **15分** | 包含失败/超时/空状态处理 | 原文引用 |

#### B. 加分项 (共 30 分，每项 5 分，有则得分)
| 检查项 | 分值 | 判定标准 | 脚本/证据 |
| :--- | :---: | :--- | :--- |
| **字段定义** | **5分** | 含类型/长度/校验规则表格 | 原文引用 |
| **权限与角色** | **5分** | 区分多角色视图/RBAC | 原文引用 |
| **非功能需求 (NFR)** | **5分** | 含性能/安全/兼容性定义 | 原文引用 |
| **旧数据兼容** | **5分** | 含迁移/洗数据策略 | 原文引用 |
| **版本记录** | **5分** | 有清晰变更日志 | 原文引用 |
| **UI/UE 引用** | **5分** | 含设计稿链接或图片 | `structure.has_images` |
